...
namespace NPOI.HSSF.Record.Chart
{
	...
	public class CrtLayout12Record : StandardRecord
	{
		...
		{
			CrtLayout12Record crtLayout12Record = new CrtLayout12Record();
			crtLayout12Record.AutoLayoutType = AutoLayoutType;
			crtLayout12Record.CheckSum = CheckSum;
			crtLayout12Record.DX = DX;
			crtLayout12Record.DY = DY;
			crtLayout12Record.HeightMode = HeightMode;
			crtLayout12Record.WidthMode = WidthMode;
			crtLayout12Record.X = X;
			crtLayout12Record.XMode = XMode;
			crtLayout12Record.Y = Y;
			crtLayout12Record.YMode = YMode;
			return crtLayout12Record;
		}
	}
}
