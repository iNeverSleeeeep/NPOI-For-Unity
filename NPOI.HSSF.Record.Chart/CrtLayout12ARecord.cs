...
namespace NPOI.HSSF.Record.Chart
{
	...
	public class CrtLayout12ARecord : StandardRecord
	{
		...
		{
			CrtLayout12ARecord crtLayout12ARecord = new CrtLayout12ARecord();
			crtLayout12ARecord.IsLayoutTargetInner = IsLayoutTargetInner;
			crtLayout12ARecord.CheckSum = CheckSum;
			crtLayout12ARecord.DX = DX;
			crtLayout12ARecord.DY = DY;
			crtLayout12ARecord.HeightMode = HeightMode;
			crtLayout12ARecord.WidthMode = WidthMode;
			crtLayout12ARecord.X = X;
			crtLayout12ARecord.XMode = XMode;
			crtLayout12ARecord.Y = Y;
			crtLayout12ARecord.YMode = YMode;
			crtLayout12ARecord.XTL = XTL;
			crtLayout12ARecord.YTL = YTL;
			crtLayout12ARecord.XBR = XBR;
			crtLayout12ARecord.YBR = YBR;
			return crtLayout12ARecord;
		}
