...
namespace NPOI.HSSF.Record.Chart
{
	...
	/// </summary>
	public class FbiRecord : StandardRecord
	{
		...
		public override object Clone()
		{
			...
			fbiRecord.field_1_xBasis = field_1_xBasis;
			fbiRecord.field_2_yBasis = field_2_yBasis;
			fbiRecord.field_3_heightBasis = field_3_heightBasis;
			fbiRecord.field_4_scale = field_4_scale;
			fbiRecord.field_5_indexToFontTable = field_5_indexToFontTable;
			return fbiRecord;
		}
	}
}
