...
namespace NPOI.HSSF.UserModel
{
	...
	public class HSSFClientAnchor : HSSFAnchor, IClientAnchor
	{
		...
		public int Row1
		{
			get
			{
				return _escherClientAnchor.Row1;
			}
			set
			{
				CheckRange(value, 0, 65536, "row1");
		...
		public int Row2
		{
			get
			{
				return _escherClientAnchor.Row2;
			}
			set
			{
				CheckRange(value, 0, 65536, "row2");
		...
		public int AnchorType
		{
			get
			{
				return _escherClientAnchor.Flag;
			}
			set
			{
