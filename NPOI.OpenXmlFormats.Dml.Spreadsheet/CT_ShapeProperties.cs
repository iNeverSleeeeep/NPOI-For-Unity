...
namespace NPOI.OpenXmlFormats.Dml.Spreadsheet
{
	...
	{
		private NPOI.OpenXmlFormats.Dml.CT_Transform2D xfrmField;
		...
		{
			xfrmField = new NPOI.OpenXmlFormats.Dml.CT_Transform2D();
			return xfrmField;
		}
		...
		public static CT_ShapeProperties Parse(XmlNode node, XmlNamespaceManager namespaceManager)
		{
			...
			foreach (XmlNode childNode in node.ChildNodes)
			{
				...
				{
					cT_ShapeProperties.xfrm = NPOI.OpenXmlFormats.Dml.CT_Transform2D.Parse(childNode, namespaceManager);
				}
