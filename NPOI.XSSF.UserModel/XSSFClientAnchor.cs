...
namespace NPOI.XSSF.UserModel
{
	...
	public class XSSFClientAnchor : XSSFAnchor, IClientAnchor
	{
		...
		public override bool Equals(object o)
		{
			...
			if (Dx1 == xSSFClientAnchor.Dx1 && Dx2 == xSSFClientAnchor.Dx2 && Dy1 == xSSFClientAnchor.Dy1 && Dy2 == xSSFClientAnchor.Dy2 && Col1 == xSSFClientAnchor.Col1 && Col2 == xSSFClientAnchor.Col2 && Row1 == xSSFClientAnchor.Row1)
			{
				return Row2 == xSSFClientAnchor.Row2;
			}
			return false;
		}
		...
		internal bool IsSet()
		{
			if (cell1.col == 0 && cell2.col == 0 && cell1.row == 0)
			{
				return cell2.row != 0;
			}
			return true;
