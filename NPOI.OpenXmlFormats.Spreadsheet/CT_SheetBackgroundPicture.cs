...
namespace NPOI.OpenXmlFormats.Spreadsheet
{
	...
	public class CT_SheetBackgroundPicture
	{
		...
		public static CT_SheetBackgroundPicture Parse(XmlNode node, XmlNamespaceManager namespaceManager)
		{
			...
			CT_SheetBackgroundPicture cT_SheetBackgroundPicture = new CT_SheetBackgroundPicture();
			cT_SheetBackgroundPicture.id = XmlHelper.ReadString(node.Attributes["id", "http://schemas.openxmlformats.org/officeDocument/2006/relationships"]);
